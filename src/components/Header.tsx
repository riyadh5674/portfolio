  ...
  return (
    ...
    >
      <nav className="container-narrow flex items-center justify-between h-16">
        ...
        <Link
          href="/"
          className="font-semibold text-sm tracking-widest uppercase text-[var(--color-text)] hover:text-[var(--color-accent)] transition-colors"
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          {mounted && (
            <button
              onClick={toggleTheme}
              className="p-2 rounded-md text-[var(--color-text-tertiary)] hover:text-[var(--color-text)] hover:bg-[var(--color-bg-warm)] transition-all"
      ...
      {mobileOpen && (
        <div className="md:hidden bg-[var(--color-bg)] border-b border-[var(--color-border)] animate-fade-in">
          <div className="container-narrow py-4 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 pt-2 border-t border-[var(--color-border-light)]">
              {mounted && (
                <button
                  onClick={toggleTheme}
                  className="p-2 rounded-md text-[var(--color-text-tertiary)] hover:text-[var(--color-text)] hover:bg-[var(--color-bg-warm)] transition-all"
